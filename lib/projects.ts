...
export const PROJECTS: Project[] = [
  {
    slug: 'accomp',
    name: 'accomp work',
    oneLiner: 'AI-matched carpooling for enterprise teams — verified colleagues only, with built-in ESG reporting and subsidy billing.',
    status: 'live',
    tags: ['agentic-ai', 'gcp'],
    liveUrl: 'https://www.accomp.ai/',
    shippedAt: '2026-03-15',
    metric: { label: 'companies onboarded', value: '182+' },
    emoji: '🚗',
    cardAccent: 'sage',
  },
  {
